...
class EvidenceView(BaseView):
    def __init__(self, db_path: str | None = None) -> None:
        ...
        form.addRow("Supported claims (JSON list):", self.supports_input)
    ...
    def _load_evidence(self, current: QtWidgets.QListWidgetItem | None) -> None:
        ...
        self.supports_input.setPlainText(evidence["supports_claims_json"])
    ...
    def _save_evidence(self) -> None:
        ...
        payload = {
            ...
            "supports_claims_json": self.supports_input.toPlainText().strip(),
